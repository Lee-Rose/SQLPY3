...
alter table album add column album_id integer references songwriter(id) not null;
alter table track add column track_id integer references album(id) not null;
alter table album drop constraint album_id nteger references songwriter(id);
